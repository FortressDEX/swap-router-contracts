...
`@cndllabs/swap-router-contracts`
and import bytecode imported from artifacts located at
`@cndllabs/swap-router-contracts/artifacts/contracts/*/*.json`.
For example:
...
} from '@cndllabs/swap-router-contracts/artifacts/contracts/SwapRouter02.sol/SwapRouter02.json'
...
via the npm artifact `@cndllabs/swap-router-contracts`, e.g.:

```solidity
import '@cndllabs/swap-router-contracts/contracts/interfaces/ISwapRouter02.sol';
